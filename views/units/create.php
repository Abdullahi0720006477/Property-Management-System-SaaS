...
<?= breadcrumbs([['label' => 'Dashboard', 'url' => '?page=dashboard'], ['label' => 'Units', 'url' => '?page=units'], ['label' => 'Add Unit', 'url' => '']]) ?>

<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0"><i class="bi bi-plus-circle me-2"></i>Add Unit</h4>
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="?page=units&action=create">
            <?php echo csrfField(); ?>
            ...
            <div class="mt-4">
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-check-lg me-1"></i> Create Unit
                </button>
                <a href="?page=units" class="btn btn-outline-secondary ms-2">Cancel</a>
            </div>
        </form>
    </div>
</div>
